...
public class PackageConfig {
     ...
     * Repo包名
     */
    private String repo = "dao.repo";

    /**
     * RepoImpl包名
     */
    private String repoImpl = "dao.repo.impl";
    ...
    public Map<String, String> getPackageInfo() {
        if (packageInfo.isEmpty()) {
            ...
            packageInfo.put(ConstVal.REPOIMPL, this.joinPackage(this.getRepoImpl()));
